...
case "${machine}" in
  ...
  darwin) readonly platform_main_manifest="TEMPLATED_npm_path/@vue/cli-service/bin/vue-cli-service.js" ;;
  windows) readonly platform_main_manifest="TEMPLATED_npm_path/@vue/cli-service/bin/vue-cli-service.js" ;;
  *) readonly platform_main_manifest="TEMPLATED_npm_path/@vue/cli-service/bin/vue-cli-service.js" ;;
esac
